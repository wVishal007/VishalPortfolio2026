...
import { Github, Linkedin, Mail, Sparkles, ExternalLink, Orbit, Atom, Zap } from "lucide-react";
              ...
              <div className="relative aspect-[4/5] bg-white/5 backdrop-blur-md border border-white/10 p-4 rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 bg-black/40 backdrop-blur-xl border border-white/10 rounded-lg">
                  <div className="flex justify-between items-center text-[8px] font-black uppercase tracking-[0.2em] text-[#E6E6FA]">
                    ...
                    <span className="flex items-center gap-1 animate-pulse"><Zap size={8} /> Online</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 order-1 lg:order-2 space-y-8 text-center lg:text-left">
            <div className="space-y-2">
              <span className="inline-flex items-center gap-2 px-4 py-1 rounded-full border border-[#E6E6FA]/20 bg-[#E6E6FA]/5 text-[10px] font-black uppercase tracking-[0.4em] text-[#E6E6FA]">
                <Orbit size={12} className="animate-spin-slow" /> Exploration Phase 2026
              </span>
            ...
            <p className="text-lg md:text-xl text-gray-400 font-light leading-relaxed max-w-2xl mx-auto lg:mx-0">
              Forging <span className="text-white font-medium">intelligent galaxies</span> through RAG pipelines and Full-Stack mastery. My work sits at the intersection of <span className="text-[#E6E6FA]">human intuition</span> and machine precision.
            </p>

            {/* 4. COSMIC TECH PILLS */}
            <div className="flex flex-wrap justify-center lg:justify-start gap-3">
              {["Agentic AI", "LLMs", "MERN", "PyTorch"].map((tech) => (
                <div key={tech} className="px-5 py-2 bg-white/5 border border-white/10 rounded-full text-[10px] font-bold uppercase tracking-widest hover:bg-[#E6E6FA] hover:text-black transition-all cursor-crosshair">
                  {tech}
                </div>
              ))}
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 pt-6">
              ...
              <div className="flex gap-6">
                {[<Github />, <Linkedin />, <Mail />].map((icon, i) => (
                  <a key={i} href="#" className="text-white/30 hover:text-[#E6E6FA] transition-all hover:scale-125">
