const ProjectCard = ({
  ...
  return (
    <div className="group relative rounded-3xl overflow-hidden bg-gradient-to-br from-blue-900/40 to-black border border-white/10 hover:border-white/30 transition-all duration-500">
